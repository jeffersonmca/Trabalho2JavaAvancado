...
public class MedicoInclui extends javax.swing.JDialog {
    ...
    public MedicoInclui(java.awt.Frame parent, boolean modal, ServicoMedico servico) {
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(layout.createSequentialGroup()
                .addComponent(jPanel1, GroupLayout.PREFERRED_SIZE, 248, GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void buttonSalvarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_buttonSalvarActionPerformed
        ...
        m.setIdade((Integer) spinnerIdade.getValue());
        m.setCpf(textCpf.getText());
        m.setSexo((EnumSexo) ComboBoxSexo.getSelectedItem());
        m.setEndereco((Endereco) ComboBoxEndereco.getSelectedItem());
        m.setContato((Contato) ComboBoxContato.getSelectedItem());
        m.setPeriodoTrabalho(textPeriodoTrabalho.getText());
        m.setEspecializacoes(especializacoes);
        
        try {
            // Salva no banco de dados o novo Medico
            servico.salvar(m);
