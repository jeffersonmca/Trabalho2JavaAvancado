...
public class ContatoInclui extends javax.swing.JDialog {

    private ServicoContato servico;
    
    public ContatoInclui(java.awt.Frame parent, boolean modal, ServicoContato servico) {
    ...
    private void buttonSalvar1ActionPerformed(ActionEvent evt) {//GEN-FIRST:event_buttonSalvar1ActionPerformed
        ...
        // Instancia um novo objeto do tipo Contato
        ...
        try {
            // Salva no banco de dados o novo Contato
            servico.salvar(c);
