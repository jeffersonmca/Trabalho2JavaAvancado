...
public class PermissaoEdita extends javax.swing.JDialog {

    private Permissao permissao;
    private ServicoPermissao servico;
    private Integer codigo;
    
    public PermissaoEdita(java.awt.Frame parent, boolean modal, ServicoPermissao servico, Permissao permissao) {
    ...
    private void buttonSalvar1ActionPerformed(ActionEvent evt) {//GEN-FIRST:event_buttonSalvar1ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(PermissaoEdita.class.getName()).log(Level.SEVERE, null, ex);
        }
