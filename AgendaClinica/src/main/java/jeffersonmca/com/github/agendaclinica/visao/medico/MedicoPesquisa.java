...
public class MedicoPesquisa extends javax.swing.JFrame {

    private ServicoMedico service;
    private List<Medico> dados;
    private MedicoTableModel tabModel;
    
    public MedicoPesquisa() {
        
        initComponents();
        
        this.service = new ServicoMedico();
    }
    ...
    private void initComponents() {
        ...
        ComboBoxOpcao.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "SEM FILTRO", "CODIGO", "NOME", "CPF", "IDADE", "SEXO", "ID ENDERECO", "ID CONTATO", "PERIODO TRABALHO" }));
    ...
    private void buttonVisualizarRelatorioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonVisualizarRelatorioActionPerformed
        ...
        try {
            ...
            g.configuraRelatorio(true, "Medicos");
    ...
    private void buttonImprimirRelatorioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonImprimirRelatorioActionPerformed
        ...
        try {
            ...
            GerenciaRelatorio g = new GerenciaRelatorio();
            g.configuraRelatorio(false, "Medicos");
