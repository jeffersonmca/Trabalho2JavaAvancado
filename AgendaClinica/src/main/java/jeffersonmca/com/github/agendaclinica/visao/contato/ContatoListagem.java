...
public class ContatoListagem extends javax.swing.JFrame {

    private ServicoContato service;
    private List<Contato> dados;
    private ContatoTableModel tabModel;
    
    public ContatoListagem() {
        
        initComponents();
        service = new ServicoContato();
        atualizaDados();
    }
    ...
    private void atualizaDados(){
        ...
        try {
            ...
            tabModel = new ContatoTableModel(dados);
            tableContatos.setModel(tabModel);
            
            // Melhorando o aspecto da grid
            tableContatos.setDefaultRenderer(Object.class, new StrippedTableCellHandler());
    ...
    private void jbtnIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnIncluirActionPerformed
        ...
        // Instancia a tela de inclusao do Contato
        ContatoInclui tela = new ContatoInclui(this, true, service);
    ...
    private void jbtnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnEditarActionPerformed
        ...
        // Pega a linha que ele selecionou e transforma em um objeto do tipo Contato
        Contato aux = dados.get(tableContatos.getSelectedRow());
        ...
        // Instancia a tela de edicao do Contato. passando de parametro
        // o servico e o Contato a ser editado
        ContatoEdita tela = new ContatoEdita(this, true, service, aux);
        tela.setVisible(true);
    ...
    private void jbtnRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnRemoverActionPerformed
        ...
        // Pergunta o usuario se ele realmente quer deletar aquele Contato
        if (JOptionPane.showConfirmDialog(this,
            ...
            try {
                // Caso a escolha fora sim entao o Contato sera removido
