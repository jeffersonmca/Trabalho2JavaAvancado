...
public class EspecializacaoPesquisa extends javax.swing.JFrame {

    private ServicoEspecializacao service;
    private List<Especializacao> dados;
    private EspecializacaoTableModel tabModel;
    
    public EspecializacaoPesquisa() {
        
        initComponents();
        
        this.service = new ServicoEspecializacao();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Pesquisa de Especialização");

        jPanel1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));

        ComboBoxOpcao.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "SEM FILTRO", "CODIGO", "NOME", "AREA" }));
    ...
    private void buttonVisualizarRelatorioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonVisualizarRelatorioActionPerformed
        ...
        try {
            ...
            g.configuraRelatorio(true, "Especializacoes");
    ...
    private void buttonImprimirRelatorioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonImprimirRelatorioActionPerformed
        ...
        try {
            ...
            GerenciaRelatorio g = new GerenciaRelatorio();
            g.configuraRelatorio(false, "Especializacoes");
