...
import jeffersonmca.com.github.agendaclinica.visao.paciente.*;
...
public class PermissaoPesquisa extends javax.swing.JFrame {

    private ServicoPermissao service;
    private List<Permissao> dados;
    private PermissaoTableModel tabModel;
    
    public PermissaoPesquisa() {
        
        initComponents();
        
        this.service = new ServicoPermissao();
    }
    ...
    private void atualizaDados() {
        ...
        try {
            ...
            tabModel = new PermissaoTableModel(dados);
            tablePermissoes.setModel(tabModel);
    ...
    private void initComponents() {
        ...
        setTitle("Pesquisa de Permissão");
    ...
    private void buttonVisualizarRelatorioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonVisualizarRelatorioActionPerformed
        ...
        try {
            ...
            g.configuraRelatorio(true, "Permissoes");
    ...
    private void buttonImprimirRelatorioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonImprimirRelatorioActionPerformed
        ...
        try {
            ...
            GerenciaRelatorio g = new GerenciaRelatorio();
            g.configuraRelatorio(false, "Permissoes");
