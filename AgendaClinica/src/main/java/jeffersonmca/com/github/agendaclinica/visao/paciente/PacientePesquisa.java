...
import jeffersonmca.com.github.agendaclinica.visao.medico.*;
import jeffersonmca.com.github.agendaclinica.visao.especializacao.*;
...
public class PacientePesquisa extends javax.swing.JFrame {

    private ServicoPaciente service;
    private List<Paciente> dados;
    private PacienteTableModel tabModel;
    
    public PacientePesquisa() {
        
        initComponents();
        
        this.service = new ServicoPaciente();
    }
    ...
    private void initComponents() {
        ...
        ComboBoxOpcao.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "SEM FILTRO", "CODIGO", "NOME", "CPF", "IDADE", "SEXO", "ID ENDERECO", "ID CONTATO", "CONVENIO" }));
    ...
    private void buttonVisualizarRelatorioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonVisualizarRelatorioActionPerformed
        ...
        try {
            ...
            g.configuraRelatorio(true, "Pacientes");
    ...
    private void buttonImprimirRelatorioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonImprimirRelatorioActionPerformed
        ...
        try {
            ...
            GerenciaRelatorio g = new GerenciaRelatorio();
            g.configuraRelatorio(false, "Pacientes");
