...
public class SecretarioPesquisa extends javax.swing.JFrame {

    private ServicoSecretario service;
    private List<Secretario> dados;
    private SecretarioTableModel tabModel;
    
    public SecretarioPesquisa() {
        
        initComponents();
        
        this.service = new ServicoSecretario();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Pesquisa de Secretário");
    ...
    private void buttonVisualizarRelatorioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonVisualizarRelatorioActionPerformed
        ...
        try {
            ...
            g.configuraRelatorio(true, "Secretarios");
    ...
    private void buttonImprimirRelatorioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonImprimirRelatorioActionPerformed
        ...
        try {
            ...
            GerenciaRelatorio g = new GerenciaRelatorio();
            g.configuraRelatorio(false, "Secretarios");
