...
public class PermissaoInclui extends javax.swing.JDialog {

    private ServicoPermissao servico;
    
    public PermissaoInclui(java.awt.Frame parent, boolean modal, ServicoPermissao servico) {
        super(parent, modal);
        initComponents();
    ...
    private void buttonSalvar1ActionPerformed(ActionEvent evt) {//GEN-FIRST:event_buttonSalvar1ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(PermissaoInclui.class.getName()).log(Level.SEVERE, null, ex);
        }
