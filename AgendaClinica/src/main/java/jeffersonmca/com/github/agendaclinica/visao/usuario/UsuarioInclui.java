...
public class UsuarioInclui extends javax.swing.JDialog {
    ...
    public UsuarioInclui(java.awt.Frame parent, boolean modal, ServicoUsuario servico) {
    ...
    private void buttonSalvarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_buttonSalvarActionPerformed
        ...
        // Instancia um novo objeto do tipo Usuario
        Usuario u = new Usuario();
        
        // Preenche esse objeto com os dados da tela
        u.setNome(textNome.getText());
        u.setIdade((Integer) spinnerIdade.getValue());
        u.setCpf(textCpf.getText());
        u.setSexo((EnumSexo) ComboBoxSexo.getSelectedItem());
        u.setEndereco((Endereco) ComboBoxEndereco.getSelectedItem());
        u.setContato((Contato) ComboBoxContato.getSelectedItem());
        u.setAutenticador(textAutenticador.getText());
        u.setSenha(String.valueOf(passwordSenha.getPassword()));
